...
size_t OptionValueFormatEntity::AutoComplete(CommandInterpreter &interpreter, CompletionRequest &request) {
  return FormatEntity::AutoComplete(request, match_start_point, max_return_elements,
